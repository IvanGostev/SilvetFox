                        ...
                        <aside class="widget widget-categories">
                            ...
                            <ul>
                                @foreach($categories as $category)
                                    <li><a href="{{route('market.category.index', $category->id)}}">{{$category->title}}</a></li>
                                @endforeach
                            </ul>
                        </aside>
                    </div>
                                ...
                                <div class="single-shop-product">
                                    ...
                                    <div class="sp-details">
                                        ...
                                        <div class="sp-details-hover">
                                            <a class="sp-cart" href="{{ route('market.product.show', $product->id) }}"></i><span>More detailed</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
