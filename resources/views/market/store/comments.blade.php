                    ...
                    <div class="header_shop  bg ">
                        <div class="wrp">
                            ...
                            <nav class="header_shop__second text-muted">
                                ...
                                <a STYLE="font-size: 16PX" href="{{ route('market.store.show', $store->id) }}" class="first   ">
                                ...
                                <a  STYLE="font-size: 16PX" href="{{ route('market.store.comments', $store->id) }}" class="active">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <div class="wrp">
                            <div class="row">
                                <div class="col-md-12 col-sm-8 col-xs-12">
                                    ...
                                    <hr>
                                    <hr>
                                    <ul class="comment_list scrollbar">
                                                ...
                                                <div class="comment ">
                                                    <div class="comment_cont">
                                                        <div class="comment_top">
                                                            <a class="name  "
                                                               href="{{ route('profile.main.show', $comment->user->id) }}"><b>{{$comment->user->name}}</b></a>
                                                            <span
                                                                class="date text-muted">{{$comment->created_at}}</span>
                                                            <a href="{{ route('market.product.show', $comment->product->id) }}"
                                                               class="text-muted over review-product-name">{{$comment->product->title}}</a>
                                                        </div>
                                                        <div class="text">
                                                            {{$comment->message}}
                                                        </div>
                                                        <div class="comment_foot">
                                                            <div class="rating_star " title="Оценка 5">
