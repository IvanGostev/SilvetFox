                ...
                <div class="col-lg-12">
                    <div class="single-blog">
                        ...
                        <div class="blog-post-meta">
                                    <span><img src="{{ asset('storage/' . $user->img) }}" alt="">By <a
                                            href="{{ route('profile.main.show', $user->id) }}">{{$user->name}}</a> </span>
                                ...
                                <div class="comment-area">
                                    ...
                                    <div class="comment-form-wrapper">
                                        ...
                                        <form action="{{ route('news.comment.store') }}" method="post"
                                            ...
                                            <input type="text" name="user_id" hidden="hidden"
                                                   value="{{auth()->user()->id}}">
                                            <input type="text" name="post_id" hidden="hidden"
                                                   value="{{$post->id}}">
                                            <div class="col-lg-12 col-md-12">
                                                <input class="btn" style="background-color: #ee7926;"
