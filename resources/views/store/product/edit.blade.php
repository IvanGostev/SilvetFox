                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p style="text-transform: uppercase; color: red">If you don't want to update the images, don't attach them!</p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '1' ? 'checked' : ' ' }} @endforeach class="form-check-input" type="checkbox" name="africa" id="inlineCheckbox'1'">
                                                <label class="form-check-label" for="inlineCheckbox1">Africa</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '2' ? 'checked' : ' ' }} @endforeach  class="form-check-input" type="checkbox" id="inlineCheckbox2" name="north_america">
                                                <label class="form-check-label" for="inlineCheckbox2">North America</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '3' ? 'checked' : ' ' }} @endforeach  class="form-check-input" type="checkbox" id="inlineCheckbox2" name="caribbean">
                                                <label class="form-check-label" for="inlineCheckbox2">Latin America and the Caribbean</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '4' ? 'checked' : ' ' }} @endforeach class="form-check-input" type="checkbox" id="inlineCheckbox2" name="asia">
                                                <label class="form-check-label" for="inlineCheckbox2">Asia</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '5' ? 'checked' : ' ' }} @endforeach class="form-check-input" type="checkbox" id="inlineCheckbox2" name="australia">
                                                <label class="form-check-label" for="inlineCheckbox2">Australia and Oceania</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '6' ? 'checked' : ' ' }} @endforeach class="form-check-input" type="checkbox" id="inlineCheckbox2"  name="europe">
                                                <label class="form-check-label" for="inlineCheckbox2">Europe</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input @foreach($regions as $region) {{ $region == '7' ? 'checked' : ' ' }} @endforeach class="form-check-input" type="checkbox" id="inlineCheckbox2"  name="russia">
