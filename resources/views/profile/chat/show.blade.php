@extends('profile.chat.layouts.main')
@section('content')
    ...
    {{--                    <h2 class="banner-title">Chats</h2>--}}
    {{--                </div>--}}
    {{--            </div>--}}
    {{--        </div>--}}
    {{--    </section>--}}
...
{{--                                        <small>Last seen: 2 hours ago</small>--}}
                                ...
                                @foreach($messages as $message)
                                    @if($message['type'] == 'My')
                                        <li class="clearfix">
                                            ...
                                            <div class="message other-message float-right"> {{$message->message}}
                                            </div>
                                        </li>
                                    @elseif($message['type'] == 'His')
                                        <li class="clearfix">
                        ...
                        <div class="chat-message clearfix">
                            <form action="{{ route('profile.chat.message.store', $user->id) }}" method="post">
                                @csrf
                                <div class="input-group mb-0">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-send"></i></span>
                                    </div>
                                    <input type="text" hidden="hidden" name="second_user_id" value="{{$user->id}}">
