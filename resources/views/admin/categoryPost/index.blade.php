            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Категории</h4> <h3><a href="{{ route('admin.categoryPost.create') }}"
                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{ route('admin.categoryPost.edit', $category->id) }}"
                                                       class="btn btn-outline-success btn-sm">Редактировать</a> 	&nbsp;
                                                <form class="" action="{{ route('admin.categoryPost.destroy', $category->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
