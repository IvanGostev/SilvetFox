                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate=""
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="validationCustom02"
                                                           placeholder="Баланс" name="balance"
                                        ...
                                        @else
                                            <input type="number" class="form-control" hidden="hidden"
                                                   id="validationCustom02" placeholder="Баланс" name="balance"
                                                   value="{{$user->balance}}" required="">
                                        @endif
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="role" id="inlineFormSelectPref">
                                                    <option {{ $user->role == 0 ? 'selected' : '' }}  value="0">
                                                        Покупатель
                                                    </option>
                                                    ...
                                                    @if(auth()->user()->role == 3)
                                                        ...
                                                        <option {{ $user->role == 3 ? 'selected' : '' }}  value="3">
                                                            Администратор
                                                        </option>
                                                    @endif
                                                </select>
