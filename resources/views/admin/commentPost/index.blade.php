            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Комментарии к постам</h4> <h3><a href="{{ route('admin.category.create') }}"
                                    ...
                                    <table class="table table-centered table-nowrap mb-0">
                                        ...
                                        @foreach($comments as $comment)
                                            <tr>
                                                ...
                                                <td class="d-flex">&nbsp;
                                                <form class="" action="{{ route('admin.commentPost.destroy', $comment->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
